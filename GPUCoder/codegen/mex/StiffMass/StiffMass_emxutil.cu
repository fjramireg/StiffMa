  ...
  boolean_T doPush)
{
  ...
  *pEmxArray = (emxArray_boolean_T *)emlrtMallocMex(sizeof(emxArray_boolean_T));
  ...
  emxArray->size = (int32_T *)emlrtMallocMex(sizeof(int32_T) * b_numDimensions);
...
void emxInit_real_T(emxArray_real_T **pEmxArray, int32_T b_numDimensions,
                    boolean_T doPush)
{
...
void emxInit_uint32_T(emxArray_uint32_T **pEmxArray, int32_T b_numDimensions,
                      boolean_T doPush)
{
...
/* End of code generation (StiffMass_emxutil.cu) */
