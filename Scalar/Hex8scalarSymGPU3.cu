...
template __global__ void Hex8scalar<float,unsigned int>(const unsigned int *, const float *, const unsigned int, const unsigned int, const float, float *);    // NNZ: 'single'
template __global__ void Hex8scalar<double,unsigned int>(const unsigned int *, const double *, const unsigned int, const unsigned int, const double, double *);// NNZ: 'double'
