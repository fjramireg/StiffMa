function [iK, jK] = Index_sps(elements, sets)
...
%   [iK, jK]=INDEX_SPS(elements, sets) returns the rows "iK" and columns "jK"
...
%   is the connectivity matrix of size 8xnel and dType is the data type
%   defined to the "elements" array.  The struct "sets" must contain
