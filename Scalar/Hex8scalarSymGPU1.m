...
function KE = Hex8scalarSymGPU1(elements,nodes,c)
...
ker = parallel.gpu.CUDAKernel('Hex8scalarSymGPU1.ptx',...
    'const unsigned int *, const double *, const unsigned int, const unsigned int, const double, const double *, double *',...
...
KE = feval(ker, elements', nodes', nel, nnod, c, L, KE); % GPU code execution
