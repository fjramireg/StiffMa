...
template <typename floatT>
        ...
        const unsigned int nel, const unsigned int nnod, const floatT c, const floatT *L, floatT *ke ) {
...
template __global__ void Hex8scalar<float>(const unsigned int *, const float *, const unsigned int, const unsigned int, const float, const float *, float *);       // NNZ: 'single'
template __global__ void Hex8scalar<double>(const unsigned int *, const double *, const unsigned int, const unsigned int, const double, const double *, double *);  // NNZ: 'double'
