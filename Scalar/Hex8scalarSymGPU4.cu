...
template __global__ void Hex8scalar<float,unsigned int>(const unsigned int *, const float *, const unsigned int, const unsigned int, const float, float *);        // NNZ: 'single'. Indices: 'uint32'
template __global__ void Hex8scalar<double,unsigned int>(const unsigned int *, const double *, const unsigned int, const unsigned int, const double, double *);    // NNZ: 'double'. Indices: 'uint32'
template __global__ void Hex8scalar<float,unsigned long>(const unsigned long *, const float *, const unsigned long, const unsigned long, const float, float *);    // NNZ: 'single'. Indices: 'uint64'
template __global__ void Hex8scalar<double,unsigned long>(const unsigned long *, const double *, const unsigned long, const unsigned long, const double, double *);// NNZ: 'double'. Indices: 'uint64'
