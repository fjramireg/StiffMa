  ...
  cmp_tunableEnvironment[2])
{
  ...
  if (1 < xend) {
    if (xend <= 32) {
      insertionsort(x_data, 1, xend, cmp_tunableEnvironment);
    } else {
      pmax = 31;
      pmin = 0;
      exitg1 = false;
      while ((!static_cast<int32_T>(exitg1)) && (static_cast<int32_T>((pmax -
                pmin > 1)))) {
        xmid = (pmin + pmax) >> 1;
        pow2p = 1 << xmid;
        if (pow2p == xend) {
      ...
      while (st_n > 0) {
        ...
        if ((frame.xend - frame.xstart) + 1 <= 32) {
          insertionsort(x_data, frame.xstart, frame.xend, cmp_tunableEnvironment);
        } else if (frame.depth == MAXDEPTH) {
          b_heapsort(x_data, frame.xstart, frame.xend, cmp_tunableEnvironment);
        } else {
          xmid = (frame.xstart + (frame.xend - frame.xstart) / 2) - 1;
          varargout_1 = ((static_cast<int32_T>((cmp_tunableEnvironment[0].
            f1.data[x_data[xmid] - 1] < cmp_tunableEnvironment[0]
            .f1.data[x_data[frame.xstart - 1] - 1]))) || (static_cast<int32_T>
            (((static_cast<int32_T>((cmp_tunableEnvironment[0]
            .f1.data[x_data[xmid] - 1] == cmp_tunableEnvironment[0]
            .f1.data[x_data[frame.xstart - 1] - 1]))) && (static_cast<int32_T>
            ((cmp_tunableEnvironment[1].f1.data[x_data[xmid] - 1] <
              cmp_tunableEnvironment[1].f1.data[x_data[pmax] - 1])))))));
          if (varargout_1) {
          ...
          varargout_1 = ((static_cast<int32_T>((cmp_tunableEnvironment[0].
            f1.data[x_data[frame.xend - 1] - 1] < cmp_tunableEnvironment[0].
            f1.data[x_data[frame.xstart - 1] - 1]))) || (static_cast<int32_T>(((
            static_cast<int32_T>((cmp_tunableEnvironment[0]
            .f1.data[x_data[frame.xend - 1] - 1] == cmp_tunableEnvironment[0].
            f1.data[x_data[frame.xstart - 1] - 1]))) && (static_cast<int32_T>
            ((cmp_tunableEnvironment[1].f1.data[x_data[pmin] - 1] <
              cmp_tunableEnvironment[1].f1.data[x_data[pmax] - 1])))))));
          if (varargout_1) {
            t = x_data[frame.xstart - 1];
          ...
          varargout_1 = ((static_cast<int32_T>((cmp_tunableEnvironment[0].
            f1.data[x_data[frame.xend - 1] - 1] < cmp_tunableEnvironment[0].
            f1.data[x_data[xmid] - 1]))) || (static_cast<int32_T>
            (((static_cast<int32_T>((cmp_tunableEnvironment[0]
            .f1.data[x_data[frame.xend - 1] - 1] == cmp_tunableEnvironment[0].
            f1.data[x_data[xmid] - 1]))) && (static_cast<int32_T>
            ((cmp_tunableEnvironment[1].f1.data[x_data[pmin] - 1] <
          ...
          if (varargout_1) {
            t = x_data[xmid];
            x_data[xmid] = x_data[frame.xend - 1];
            x_data[frame.xend - 1] = t;
          }
          ...
          do {
            ...
            do {
              exitg3 = 0;
              varargout_1 = ((static_cast<int32_T>((cmp_tunableEnvironment[0].
                f1.data[x_data[pmax] - 1] < cmp_tunableEnvironment[0]
                .f1.data[pow2p]))) || (static_cast<int32_T>
                (((static_cast<int32_T>((cmp_tunableEnvironment[0]
                .f1.data[x_data[pmax] - 1] == cmp_tunableEnvironment[0]
                .f1.data[pow2p]))) && (static_cast<int32_T>
                ((cmp_tunableEnvironment[1].f1.data[x_data[pmax] - 1] <
            ...
            do {
              exitg3 = 0;
              varargout_1 = ((static_cast<int32_T>((cmp_tunableEnvironment[0].
                f1.data[pow2p] < cmp_tunableEnvironment[0].f1.data[x_data[pmin]
                - 1]))) || (static_cast<int32_T>(((static_cast<int32_T>
                ((cmp_tunableEnvironment[0].f1.data[pow2p] ==
                  cmp_tunableEnvironment[0].f1.data[x_data[pmin] - 1]))) && (
                static_cast<int32_T>((cmp_tunableEnvironment[1].f1.data[pow2p] <
                cmp_tunableEnvironment[1].f1.data[x_data[pmin] - 1])))))));
              if (varargout_1) {
                pmin--;
              } else {
