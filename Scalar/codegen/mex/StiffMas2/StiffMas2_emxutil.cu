 ...
 *
 * StiffMas2_emxutil.cu
 *
 * Code generation for function 'StiffMas2_emxutil'
 *
 */
...
static void emxInitStruct_cell_wrap_2(cell_wrap_2 *pStruct, boolean_T doPush)
{
  emxInit_int32_T(&pStruct->f1, 1, doPush);
}
...
void c_emxInitStruct_coder_internal_(coder_internal_sparse *pStruct, boolean_T
  doPush)
{
  emxInit_real_T(&pStruct->d, 1, doPush);
  emxInit_int32_T(&pStruct->colidx, 1, doPush);
  emxInit_int32_T(&pStruct->rowidx, 1, doPush);
}
...
/* End of code generation (StiffMas2_emxutil.cu) */
