 ...
 *
 * _coder_StiffMas2_api.cu
 *
 * Code generation for function '_coder_StiffMas2_api'
 *
 */
...
void StiffMas2_api(const mxArray * const prhs[3], int32_T, const mxArray *plhs[1])
{
...
/* End of code generation (_coder_StiffMas2_api.cu) */
