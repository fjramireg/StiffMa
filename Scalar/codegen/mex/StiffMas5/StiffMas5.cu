...
static __global__ void StiffMas5_kernel1(const emxArray_uint32_T *elements,
  emxArray_real_T *Ke);
static __global__ void StiffMas5_kernel10(const int32_T jy, const int32_T jp1j,
  real_T Jac[9]);
static __global__ void StiffMas5_kernel11(const int32_T jp1j, const real_T Jac[9],
  const int32_T jy, const real_T L[24], const int32_T jA, real_T B[24]);
static __global__ void StiffMas5_kernel12(const real_T B[24], real_T b_B[64]);
static __global__ void StiffMas5_kernel13(const real_T B[64], const real_T smax,
  const emxArray_real_T *Ke, const int32_T e, real_T b_Ke[64]);
static __global__ void StiffMas5_kernel14(const real_T Ke[64], const int32_T e,
  emxArray_real_T *b_Ke);
static __global__ void StiffMas5_kernel15(const emxArray_uint32_T *iK, const
  int32_T iy, emxArray_uint32_T *result);
static __global__ void StiffMas5_kernel16(const emxArray_uint32_T *jK, const
  int32_T iy, emxArray_uint32_T *result);
static __global__ void StiffMas5_kernel17(int32_T SZ[2]);
static __global__ void StiffMas5_kernel18(const emxArray_uint32_T *result,
  int32_T SZ[2]);
static __global__ void StiffMas5_kernel19(const emxArray_uint32_T *result, const
  int32_T k, int32_T SZ[2]);
static __global__ void StiffMas5_kernel2(const emxArray_real_T *nodes, const
...
static __global__ void StiffMas5_kernel23(const emxArray_uint32_T *result,
  emxArray_int32_T *idx);
static __global__ void StiffMas5_kernel24(const int32_T j, const
...
static __global__ void StiffMas5_kernel27(const emxArray_uint32_T *b, const
  int32_T i, emxArray_uint32_T *b_b);
static __global__ void StiffMas5_kernel28(const emxArray_uint32_T *b,
  emxArray_uint32_T *b_b);
static __global__ void StiffMas5_kernel29(const emxArray_int32_T *idx, const
...
static __global__ void StiffMas5_kernel30(const uint32_T uv[2], emxArray_int32_T
  *r);
static __global__ void StiffMas5_kernel31(const int32_T i, emxArray_int32_T *idx);
...
static __global__ void StiffMas5_kernel37(const emxArray_uint32_T *b,
  emxArray_uint32_T *b_b);
static __global__ void StiffMas5_kernel38(const emxArray_int32_T *r, const
...
static __global__ void StiffMas5_kernel4(const emxArray_uint32_T *jK, const
  int32_T e, emxArray_uint32_T *iK);
static __global__ void StiffMas5_kernel40(const int32_T ix, const
  emxArray_int32_T *idx, const int32_T jy, const int32_T i, emxArray_int32_T
  *ipos);
static __global__ void StiffMas5_kernel41(const int32_T jy, const int32_T ix,
  emxArray_int32_T *idx);
...
static __global__ void StiffMas5_kernel45(const int32_T sz[2],
  emxArray_boolean_T *filled);
static __global__ void StiffMas5_kernel46(const int32_T sz[2], emxArray_real_T
  *Afull);
static __global__ void StiffMas5_kernel47(const int32_T sz[2], emxArray_int32_T *
  counts);
...
static __global__ void StiffMas5_kernel49(const emxArray_uint32_T *b, const
  int32_T iy, emxArray_int32_T *ridxInt);
static __global__ void StiffMas5_kernel5(const real_T X[24], const real_T L[24],
  real_T Jac[9]);
static __global__ void StiffMas5_kernel50(const emxArray_uint32_T *b, const
  int32_T iy, emxArray_int32_T *cidxInt);
static __global__ void StiffMas5_kernel51(const int32_T jA, emxArray_int32_T
  *sortedIndices);
...
static __global__ void StiffMas5_kernel6(const real_T Jac[9], real_T x[9]);
static __global__ void StiffMas5_kernel7(int8_T ipiv[3]);
static __global__ void StiffMas5_kernel8(const real_T x[9], real_T *detJ);
static __global__ void StiffMas5_kernel9(const int32_T jy, const int32_T jp1j,
  real_T Jac[9]);
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel10(const int32_T
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel11(const int32_T
...
static __global__ __launch_bounds__(64, 1) void StiffMas5_kernel12(const real_T
  B[24], real_T b_B[64])
{
  uint32_T threadId;
  real_T d;
  ...
  int32_T ibcol;
  threadId = static_cast<uint32_T>(mwGetGlobalThreadIndex());
  ibcol = static_cast<int32_T>((threadId % 8U));
  itilerow = static_cast<int32_T>(((threadId - static_cast<uint32_T>(ibcol)) /
    8U));
  if (itilerow < 8) {
    d = 0.0;
...
static __global__ __launch_bounds__(64, 1) void StiffMas5_kernel13(const real_T
...
static __global__ __launch_bounds__(64, 1) void StiffMas5_kernel14(const real_T
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel17(int32_T SZ[2])
{
  uint32_T threadId;
  int32_T itilerow;
  threadId = static_cast<uint32_T>(mwGetGlobalThreadIndex());
  ...
  emxArray_uint32_T *result, int32_T SZ[2])
{
  ...
  if (ibcol < 2) {
    SZ[ibcol] = static_cast<int32_T>(result->data[result->size[0] * ibcol]);
  }
}
  ...
  emxArray_uint32_T *result, const int32_T k, int32_T SZ[2])
{
  ...
  threadId = static_cast<uint32_T>(mwGetGlobalThreadIndex());
  ibcol = static_cast<int32_T>(threadId);
  if ((static_cast<int32_T>((ibcol < 2))) && (static_cast<int32_T>((result->
         data[(k + result->size[0] * ibcol) + 1] > static_cast<uint32_T>
         (SZ[ibcol]))))) {
    SZ[ibcol] = static_cast<int32_T>(result->data[(k + result->size[0] * ibcol)
      + 1]);
  }
}
  ...
  real_T X[24])
{
  ...
  itilerow = static_cast<int32_T>(((threadId - static_cast<uint32_T>(jcol)) / 8U));
  if (itilerow < 3) {
    X[jcol + (itilerow << 3)] = nodes->data[(static_cast<int32_T>(elements->
      data[e + elements->size[0] * jcol]) + nodes->size[0] * itilerow) - 1];
  }
}
  ...
  emxArray_uint32_T *result, const int32_T i, emxArray_int32_T *idx)
{
  ...
  for (b_idx = threadId; b_idx <= static_cast<uint32_T>(loopEnd); b_idx +=
    ...
    jcol = 1;
    exitg1 = false;
    while ((!static_cast<int32_T>(exitg1)) && (static_cast<int32_T>((jcol < 3))))
    {
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel24(const
  ...
  int32_T iy, emxArray_uint32_T *ycol)
{
  ...
  for (b_idx = threadId; b_idx <= static_cast<uint32_T>(loopEnd); b_idx +=
       threadStride) {
    ibcol = static_cast<int32_T>(b_idx);
  ...
  emxArray_uint32_T *b, const int32_T i, emxArray_uint32_T *b_b)
{
  ...
  for (idx = threadId; idx <= static_cast<uint32_T>(loopEnd); idx +=
       threadStride) {
    jcol = static_cast<int32_T>((idx % (static_cast<uint32_T>(i) + 1U)));
    itilerow = static_cast<int32_T>(((idx - static_cast<uint32_T>(jcol)) / (
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel31(const
  int32_T i, emxArray_int32_T *idx)
{
  uint32_T threadId;
  uint32_T threadStride;
  ...
  emxArray_uint32_T *b, const emxArray_int32_T *r, emxArray_uint32_T *b_b)
{
  ...
  for (idx = threadId; idx <= static_cast<uint32_T>(loopEnd); idx +=
       threadStride) {
    jcol = static_cast<int32_T>((idx % static_cast<uint32_T>(r->size[0])));
    tmpIndex = (idx - static_cast<uint32_T>(jcol)) / static_cast<uint32_T>
      (r->size[0]);
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel40(const
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel41(const int32_T
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel45(const
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel46(const
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel47(const
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel5(const real_T
  X[24], const real_T L[24], real_T Jac[9])
{
  ...
  int32_T ibcol;
  threadId = static_cast<uint32_T>(mwGetGlobalThreadIndex());
  ibcol = static_cast<int32_T>((threadId % 3U));
  itilerow = static_cast<int32_T>(((threadId - static_cast<uint32_T>(ibcol)) /
    3U));
  if (itilerow < 3) {
    d = 0.0;
...
static __global__ __launch_bounds__(1024, 1) void StiffMas5_kernel51(const
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel6(const real_T
  Jac[9], real_T x[9])
{
  uint32_T threadId;
  int32_T itilerow;
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel7(int8_T ipiv[3])
{
  uint32_T threadId;
  int32_T itilerow;
  threadId = static_cast<uint32_T>(mwGetGlobalThreadIndex());
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel8(const real_T
  x[9], real_T *detJ)
{
  uint32_T idx;
  real_T tmpRed0;
...
static __global__ __launch_bounds__(32, 1) void StiffMas5_kernel9(const int32_T
  jy, const int32_T jp1j, real_T Jac[9])
{
  uint32_T threadId;
  int32_T tmpIdx;
               ...
               real_T c, coder_internal_sparse *K)
{
  ...
  if (result->size[0] == 0) {
    ...
    b_dirtyOnCpu = true;
    x_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>
    ...
    i = result->size[0] - 1;
    f_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((i - 1) / 2
    ...
    while (b_i < n - 1) {
      ...
      for (jy = b_i + 1; jy < n; jy = qEnd + b_i) {
        ...
        w_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((kEnd -
    ...
    i_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((idx->size
    ...
    while (k <= jA) {
      ...
      i = k - 1;
      v_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((i - jy)
    ...
    b_b_dirtyOnCpu = true;
    j_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((i + 1L) *
    ...
    emxEnsureCapacity_uint32_T(b, i);
    b_dirtyOnCpu = true;
    k_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((b_b->size
    ...
    l_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((ix - 1) +
    ...
    r_dirtyOnCpu = true;
    m_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((
      static_cast<int32_T>(uv[0]) - 1) + 1L)), &m_grid, &m_block, 1024U, 65535U);
    ...
    if (indx->size[0] != 0) {
      ...
      n_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>((i + 1L)),
      ...
      i = indx->size[0] - 1;
      o_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((i - 1) /
      ...
      while (b_i < n - 1) {
        ...
        for (jy = b_i + 1; jy < n; jy = qEnd + b_i) {
          ...
          q_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((kEnd
      ...
      p_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>
    ...
    c_b_dirtyOnCpu = true;
    r_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>((((r->size[0]
    ...
    emxEnsureCapacity_uint32_T(b, i);
    b_dirtyOnCpu = true;
    s_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((c_b->size
    ...
    t_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((ix - 1) +
    ...
    emxEnsureCapacity_int32_T(ipos, i);
    ipos_dirtyOnCpu = true;
    u_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((ipos->
  ...
  y_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((ipos->size[0]
  ...
  gb_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((jA - 1) +
  ...
  hb_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>
  ...
  ib_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((iy - 1) +
  ...
  b_t_dirtyOnCpu = true;
  jb_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>
  ...
  kb_validLaunchParams = mwGetLaunchParameters(static_cast<real_T>(((iy - 1) +
...
/* End of code generation (StiffMas5.cu) */
