...
if strcmp(sets.prob_type,'Scalar')
    ...
    elseif strcmp(sets.proc_type,'GPU')
        ...
        fprintf(fileID,"[iKd, jKd] = Index_spsa(gpuArray(Mesh.elements'), sets);\n");
        fprintf(fileID,"Ked = eStiff_spsa(gpuArray(Mesh.elements'), gpuArray(Mesh.nodes'), c, sets);\n");
...
elseif strcmp(sets.prob_type,'Vector')
    ...
    elseif strcmp(sets.proc_type,'GPU')
        ...
        fprintf(fileID,"sets.numSMs   = d.MultiprocessorCount;\n");
        fprintf(fileID,"sets.WarpSize = d.SIMDWidth;\n");
        fprintf(fileID,"[iKd, jKd] = Index_vpsa(gpuArray(Mesh.elements'), sets);\n");
        fprintf(fileID,"Ked = eStiff_vpsa(gpuArray(Mesh.elements'), gpuArray(Mesh.nodes'), MP, sets);\n");
