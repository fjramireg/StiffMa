function Ke = eStiff_vosa2(MP)
% ESTIFF_VOSA2 Compute the element stiffness matrix for a VECTOR (v) problem
% by using optimized (o) CPU code for computing the symmety (s) part of ke.
%
%   KE = ESTIFF_VOSA2(MP) returns the element stiffness matrix "ke"
%   for an Hex8 element in a finite element analysis of vector problems in
%   a three-dimensional domain taking advantage of symmetry but with an
