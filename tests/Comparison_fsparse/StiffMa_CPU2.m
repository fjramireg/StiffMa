function K = StiffMa_CPU2(nelx, nely, nelz, MP)
% STIFFMA_CPU2 is a function to generate the STIFFnes MAtrix on the CPU for
...
% Dimitar Lukarski.
% 
% K = STIFFMA_CPU2(nelx ,nely ,nelz, MP) returns the lower-triangle of a
