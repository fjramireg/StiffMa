function K = StiffMa_CPU(nelx ,nely ,nelz)
...
% Dimitar Lukarski.
% 
% K = STIFFMA_CPU(nelx ,nely ,nelz) returns the lower-triangle of a sparse
%   matrix K from finite element analysis in vector problems in a
...
E0 = 200e9;         % Young modulus of solid
nu = 0.3;       % Poisson ratio

%% Indices computation 
nEl = nelx * nely * nelz ;              % number of elements #3D#
% elNrs = reshape ( 1 : nEl , nely , nelz , nelx ); % element numbering #3D#
...
Ke = E0/(1+ nu) /(2* nu -1) /144 *( [ -32; -6; -6;8;6;6;10;6;3; -4; -6; -3; -4; -3; -6;10;...
