...
% MM_TO_MSM is a MATLAB library which reads the information stored in a Matrix
% Market file and sets it up as a MATLAB sparse matrix.
%
%  Discussion:
%
...
%   web('https://people.sc.fsu.edu/~jburkardt/m_src/mm_to_msm/mm_to_msm.html')">this web site</a>.
%
