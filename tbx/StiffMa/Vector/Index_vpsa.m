function [iK, jK] = Index_vpsa(elements, sets)
...
% for the mesh.
%   [iK, jK] = INDEX_VPSA(elements, sets) returns the rows "iK" and columns "jK"
...
%   8xnel. The struct "sets" must contain several similation parameters:
