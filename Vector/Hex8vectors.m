function ke = Hex8vectors(X,D)
% HEX8VECTORS Compute the element stiffness matrix for a VECTOR problem in SERIAL computing.
%   HEX8VECTORS(X,D) returns the element stiffness matrix "ke" for an element
%   "e"  in a finite element analysis of vector problems in a three-dimensional
%   domain computed in a serial manner on the CPU,  where "X" is the nodal
%   coordinates of the element "e" (size 8x3), and "D" the material property
%   matrix of size 6x6 .
%
%   See also STIFFMAV
%
