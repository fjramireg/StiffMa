...
fprintf('\nThe mesh was generated successfully with 8 nodes Brick element! \n');
...
conect = zeros(8, nelx*nely*nelz,'uint32');
el = 0;
for elz= 1:nelz
    for ely = 1:nely
        for elx = 1:nelx
            ...
            n8 = n5+nx;
            el = el + 1;
            conect(:, el)=[n1; n1+1; n4+1; n4; n5; n5+1; n8+1; n8];
        end
    end
end
